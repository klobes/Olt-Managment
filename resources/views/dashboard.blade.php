    ...
    <script>
        $(document).ready(function() {
            ...
            const performanceChart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: {!! json_encode($performance['labels'] ?? []) !!},
                    datasets: [
                        {
                            label: '{{ trans("plugins/fiberhome-olt-manager::dashboard.cpu_usage") }}',
                            data: {!! json_encode($performance['cpu'] ?? []) !!},
                            borderColor: 'rgb(255, 99, 132)',
                            backgroundColor: 'rgba(255, 99, 132, 0.2)',
                            tension: 0.1
                        },
                        {
                            label: '{{ trans("plugins/fiberhome-olt-manager::dashboard.memory_usage") }}',
                            data: {!! json_encode($performance['memory'] ?? []) !!},
